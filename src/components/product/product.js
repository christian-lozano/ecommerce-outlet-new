    ...
    <>
      <div className=" flex h-full flex-col justify-around   border-[1px] p-2 border-blue-gray-300  dark:border-none ">
        <div className="aspect-h-1 aspect-w-1  overflow-hidden  rounded-md    group-hover:opacity-75 ">
          ...
          {descuentos.descuentooutlet || descuentos.descuentooutlet > 0 ? (
                  ...
                  <>
                    {!products.preciomanual && (
                      <span className="flex justify-center bg-black px-3 py-1">
                        {" "}
                        {!stock && descuentos.descuentooutlet
                          ? `-${descuentos.descuentooutlet}%`
                          : "Agotado"}
                      </span>
                    )}
                    {descuentos.descuentooutlet && !products.preciomanual ? (
              ...
              <div className=" mt-1 text-xs text-white ">
                <div className="flex flex-col">
                  <>
                    ...
                    {descuentos.descuentooutlet === undefined ||
                    descuentos.descuentooutlet === null ? (
                      <>
                        {!stock &&
                        products.descuento &&
                        !products.preciomanual ? (
        ...
        >
          ...
          <div className="flex">
            {descuentos.descuentooutlet > 0 || products.descuento ? (
              <>
                {descuentos.descuentooutlet && !products.preciomanual ? (
