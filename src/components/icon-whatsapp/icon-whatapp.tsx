...
import { LogoFritzSport } from "../logo/logo-fritz-sport";
...
export default function IconWhatapp({ urlWhatsApp }: Props) {
  return (
    <>
            ...
            <div className=" overflow-y-scroll xl:h-[60vh] h-[80vh] xl:w-[40vw] w-full xl:p-8 xl:py-5 p-2">
              ...
              <div>
                ...
                <p className="text-xs xl:text-base">
                  ...
                  listo para que puedes pasar a recoger el producto. Cualquier
      ...
      <div
        className="z-header  sticky-0 fixed bottom-14 right-4 z-[999] flex items-center justify-center xl:bottom-[100px] xl:right-16 "
        rel="noreferrer"
      >
        <div className=" relative mb-[6vh]  flex  h-[50px] cursor-pointer  items-center  justify-center rounded-r-full    md:w-10">
          <span className="absolute h-[30px] w-[30px] animate-ping rounded-full bg-black  dark:bg-white xl:h-[50px] xl:w-[50px] "></span>
          <div className="flex p-1 items-center justify-center xl:h-[50px] xl:w-[50px] xl:justify-center dark:bg-black bg-white  xl:p-8 rounded-full">
            <LogoFritzSport />
          </div>
        </div>
      </div>
      <Link
        ...
        target="_blank"
        className="z-header sticky-0 fixed bottom-0 right-0 z-[999] xl:right-14"
        rel="noreferrer"
      >
