...
export default async function Page({ searchParams }: Props) {
  async function fetchNextPage() {
    ...
    const filter = `*[${productFilter}${colorFilter}${categoryFilter}${sizeFilter}${searchFilter}${generoFilter}${tipoFilter}${marcaFilter}${coleccionFilter}${tallaFilter}] | order(_createdAt desc) | order(preciomanual desc) | order(stock desc)`;
  ...
  return (
    <div>
      <div className="sticky top-[80px] z-20 h-full w-full xl:top-[80px] 2xl:top-[97px] border-b-[1px] border-blue-gray-700/20">
        <div className=" flex  w-full items-center justify-between bg-white  px-6 py-2   dark:bg-background">
